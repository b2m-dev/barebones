...
function createProductView(context, product, position) {
	...
	inner_view.addEventListener('touchstart', function(e) {
		inner_view.backgroundColor = styles.products_table_tile.selectedBackgroundColor;
		view.backgroundColor = styles.products_table_tile.selectedBackgroundColor;
	});
	...
	image.addEventListener('touchstart', function(e) {
		inner_view.backgroundColor = styles.home_button.selectedBackgroundColor;
	});

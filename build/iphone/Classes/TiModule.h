...
/**
 The base class for all PFC modules
 */
...
/**
 PFC Platform calls this method on startup.
 */
-(void)startup;

/**
 PFC Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PFC Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PFC Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PFC Platform calls this method on resume.
 @param sender The sender of the event.
 */

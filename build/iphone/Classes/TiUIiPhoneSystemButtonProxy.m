...
MAKE_SYSTEM_PROP(ACTIVITY,UIPFCNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIPFCNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIPFCNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIPFCNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIPFCNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIPFCNativeItemContactAdd);
